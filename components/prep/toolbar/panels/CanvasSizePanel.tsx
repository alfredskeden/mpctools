...
export function CanvasSizePanel({
  ...
  const step = nearestCanvasStep(canvasWidth);
  const stepSize = canvasSizeForStep(step);
    ...
    <div className="flex flex-col gap-4">
      ...
      <fieldset>
        ...
        {isNative && (
          <p className="mt-1.5 text-xs text-text-tertiary">
            Image stays at its native pixel size. The canvas moves through
            11:15 sizes and crops on export.
          </p>
        )}
      </fieldset>
      ...
      {isNative ? (
        ...
        <fieldset>
          ...
          />
          <p
            className="mt-1.5 font-mono text-xs text-text-secondary"
            data-testid="canvas-step-size"
          >
            {stepSize.width} x {stepSize.height}
          </p>
          <p className="mt-1.5 text-xs text-text-tertiary">
